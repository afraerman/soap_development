...
public:
	FullMotionIntegrator(Satellite* satellite, Time* time, double interval, double step = -1.0, double output_step = 0.0, bool autostep = true, double tolerance = 1e-5,
		int number_of_equations = 3, int number_of_iterations = 2, int nor = 7, int ntrial = 4, double tolx = 1e-20, double tolf = 1e-20) :
		//Integrator(satellite, time, interval, step, autostep, tolerance),
